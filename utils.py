...
def organic_move_to(target_x, target_y, duration_ms):
    ...
    mid_x = (start_x + target_x) / 2 + random.randint(int(- distance_x / 10), int(distance_x / 10))  # Random deviation for organic effect
    mid_y = (start_y + target_y) / 2 + random.randint(int(- distance_y / 10), int(distance_x / 10))  # Random deviation for organic effect
